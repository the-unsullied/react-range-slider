...
(function(Buffer) {
  ...
  describe('asn1.js RFC5280', function() {
    ...
    it('should decode ECC Certificate', function() {
      ...
      var tbs = res.tbsCertificate;
      assert.equal(tbs.version, 'v3');
      assert.deepEqual(tbs.serialNumber, new asn1.bignum('4d955d20af85c49f6925fbab7c665f89', 16));
      assert.equal(tbs.signature.algorithm.join('.'), '1.2.840.10045.4.3.3');
      var spki = rfc5280.SubjectPublicKeyInfo.encode(tbs.subjectPublicKeyInfo, 'der');
      assert.equal(spki.toString('base64'), 'MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAE3QQ9svKQk5fG6bu8kdtR8KO' + 'G7fvG04WTMgVJ4ASDYZZR/1chrgvaDucEoX/bKhy9ypg1xXFzQM3oaqtUhE' + 'Mm4g==');
    });
    it('should decode AuthorityInfoAccess', function() {
      var data = new Buffer('305a302b06082b06010505073002861f687474703a2f2f70' + '6b692e676f6f676c652e636f6d2f47494147322e63727430' + '2b06082b06010505073001861f687474703a2f2f636c6965' + '6e7473312e676f6f676c652e636f6d2f6f637370', 'hex');
    ...
    it('should decode Certificate Extensions', function() {
      ...
      assert.equal(extensions.authorityInformationAccess.extnValue[0].accessLocation.value, 'http://ocsp.godaddy.com/');
      extensions = {};
